            ...
            <div className="max-w-4xl mx-auto">
              <div className="rounded-xl border border-[#ff6a1a]/30 bg-gradient-to-br from-[#ff6a1a]/5 to-orange-500/5 p-4 sm:p-5">
                ...
                <p className="text-sm text-foreground/80 leading-relaxed mb-3">
                  Sahara is your AI-powered founder operating system. Your mentor Fred Cary has advised hundreds of companies, taken two public, and mentored hundreds of founders.
                </p>
