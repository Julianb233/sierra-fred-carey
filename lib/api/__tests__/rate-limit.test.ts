...
describe("Rate Limiting", () => {
  describe("checkRateLimit", () => {
    ...
    it("should track limits per identifier", () => {
  ...
  describe("checkRateLimitForUser", () => {
    it("should check rate limit for a user", () => {
      const req = createMockRequest();
      const userId = `user-${Date.now()}`;

      const { response, result } = checkRateLimitForUser(req, userId, "free");
    ...
    it("should support different tiers", () => {
      ...
      const freeResult = checkRateLimitForUser(req, freeUserId, "free");
      const proResult = checkRateLimitForUser(req, proUserId, "pro");
