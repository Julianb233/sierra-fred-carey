...
export const MEDIA_TYPES = ['image', 'screenshot', 'video', 'audio'] as const
export const MEDIA_PROCESSING_STATUSES = ['none', 'pending', 'processing', 'completed', 'failed'] as const
export const MAX_MEDIA_URLS = 5
export const ALLOWED_MEDIA_EXTENSIONS = ['.png', '.jpg', '.jpeg', '.gif', '.webp', '.svg'] as const
