...
export default function PricingPage() {
  const plans = [
    {
      ...
      subtitle: "Discovery",
      price: 0,
      description: "Chat with Fred, get your idea scored, and start your founder journey.",
      audience: "First-time founders, early ideation, exploring whether to build.",
      gradient: "from-gray-400 to-gray-500",
      glowColor: "rgba(156, 163, 175, 0.3)",
      icon: StarIcon,
      features: [
        { name: "Chat with Fred AI Mentor", included: true },
        { name: "One-time Document Scoring (A-F grade)", included: true },
        { name: "Startup Reality Lens", included: true },
        { name: "Red Flag Detection", included: true },
        { name: "Founder wellbeing support", included: true },
        { name: "Discovery & Ideation stages", included: true },
    ...
    },
    {
      ...
      subtitle: "$99/month",
      price: 99,
      description: "Full journey through Seed stage with living documents and monitoring.",
      audience: "Pre-seed and seed founders actively building and preparing to fundraise.",
      gradient: "from-[#ff6a1a] to-orange-400",
      glowColor: "rgba(255, 106, 26, 0.4)",
      icon: RocketIcon,
      features: [
        { name: "Everything in Free", included: true },
        { name: "Document Storage & Improvement", included: true },
        { name: "Market-Change Alerts", included: true },
        { name: "Full Journey through Seed Stage", included: true },
        ...
        { name: "Strategy Documents & 30/60/90 Plans", included: true },
    ...
    },
    {
      ...
      subtitle: "$249/month",
      price: 249,
      description: "Warm investor intros, AI agents, and full execution support.",
      audience: "Founders actively fundraising, scaling operations, and building teams.",
      gradient: "from-orange-600 to-[#ff6a1a]",
      glowColor: "rgba(234, 88, 12, 0.3)",
      icon: LightningBoltIcon,
      features: [
        { name: "Everything in Builder", included: true },
        { name: "Boardy.ai Warm Investor Intros", included: true },
        { name: "Investor Matching & Targeting", included: true },
        { name: "Outreach Sequencing", included: true },
        { name: "Weekly SMS Check-Ins", included: true },
        { name: "Founder Ops AI Agent", included: true },
        { name: "Marketing Guru AI Agent", included: true },
        { name: "Fundraise Ops AI Agent", included: true },
        { name: "Growth Ops AI Agent", included: true },
  ...
  const comparisonFeatures = [
    { name: "Chat with Fred AI Mentor", free: true, fundraising: true, studio: true },
    { name: "Document Scoring (A-F)", free: true, fundraising: true, studio: true },
    { name: "Document Storage & Monitoring", free: false, fundraising: true, studio: true },
    { name: "Full Journey (through Seed)", free: false, fundraising: true, studio: true },
    { name: "Investor Lens & Readiness Score", free: false, fundraising: true, studio: true },
    { name: "Pitch Deck Review", free: false, fundraising: true, studio: true },
    { name: "Strategy Docs & Plans", free: false, fundraising: true, studio: true },
    { name: "Boardy.ai Warm Intros", free: false, fundraising: false, studio: true },
    { name: "Weekly SMS Check-Ins", free: false, fundraising: false, studio: true },
    { name: "AI Team Agents", free: false, fundraising: false, studio: true },
  ];
