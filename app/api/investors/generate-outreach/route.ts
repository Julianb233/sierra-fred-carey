...
Notes: ${investor.notes || "None"}`;
    ...
    const systemPrompt = `You are Fred Cary -- serial entrepreneur with ${FRED_BIO.yearsExperience}+ years of experience, hundreds of companies advised, ${FRED_BIO.ipos} IPOs, and hundreds of founders coached.
