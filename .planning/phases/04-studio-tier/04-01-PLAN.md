...
must_haves:
  ...
  key_links:
    ...
    - from: "lib/db/agent-tasks.ts"
      to: "lib/db/migrations/028_agent_tasks.sql"
...
<task type="auto">
  ...
  <action>
Create 4 SQL migration files following the exact schema from 04-RESEARCH.md. Note: migrations 026 and 027 are already taken by 026_pitch_reviews.sql and 027_strategy_documents.sql, so these start at 028.
...
<verification>
- All 4 SQL migration files exist in lib/db/migrations/ (028, 029, 030, 031)
