...
Purpose: Weekly SMS check-ins create accountability for founders and drive engagement with the platform. This is a key differentiator for Studio tier.
...
@lib/db/migrations/027_sms_checkins.sql (from Plan 01)
@lib/db/migrations/029_user_sms_preferences.sql (from Plan 01)
...
3. For each user:
   ...
   c. Optionally: query recent agent tasks for this user to generate highlights
